...
public class Launcher {
	public static void main(String[] args) throws Exception {
		...
		if ((new File("profile.txt").canWrite() && new File("profile.txt").canRead())) {
			...
			throw new Exception("Tower Battles doesn't have read/write access or is missing some files. Please try running it as an administrator, grant the specified rights or reinstall the game.");
		}
	}
}
